...
public class LocationPersistenceTesterClientMain implements SignalHandler{
    private static final Logger log = LoggerFactory.getLogger(LocationPersistenceTesterClientMain.class);
    ...
    public static void  main(String[] args){
        new LocationPersistenceTesterClientMain().run();        
    }
